...
class PokemonMoveset(moveName: String, moveType: String, basePower: Int, powerPoints: Int, accuracyLevel: Int,isSpecialAttack:Int = 0, modifiesStats: Int = 0, inflictsStatus: Int = 0, multiplier: Float = 0F) {
